  ...
  <form action="<?= site_url('welcome/create'); ?>" method="post" enctype="multipart/form-data" class="col s12">
    ...
    <div class="row">
      <div class="input-field col s12">
        ...
        <label for="deskripsi">Description</label> <!-- Ganti 'description' menjadi 'deskripsi' -->
      </div>
    </div>
    <div class="row">
      <div class="input-field col s12">
        <input name="rating" id="rating" type="text" class="validate">
        <label for="rating">Rating</label> <!-- Menambahkan input untuk rating -->
      </div>
    </div>
    <div class="row">
      <div class="input-field col s12">
        <input name="tahun" id="tahun" type="number" class="validate">
        <label for="tahun">Year</label> <!-- Input untuk tahun -->
      </div>
    </div>
    <div class="row">
      <div class="input-field col s12">
        <input name="genre" id="genre" type="text" class="validate">
        <label for="genre">Genre</label> <!-- Input untuk genre -->
      </div>
    </div>
    <div class="file-field input-field">
      <div class="btn light-blue darken-4">
        <span>Select File</span>
        <input type="file" name="cover" accept=".jpg,.png,.jpeg"> <!-- Ganti 'image1' menjadi 'cover' -->
      </div>
    ...
    <div class="row">
      <div class="input-field col s12">
        ...
        <label for="trailer_url">Trailer URL</label> <!-- Input untuk URL trailer -->
      </div>
    </div>
